// coloque aqui a URL pública do seu backend no Render
const API_BASE = "https://qrcode-ygcr.onrender.com";
...
async function render() {
  ...
  try {
    ...
    if (s.hasQR) {
      ...
      try {
        const resp = await fetch(`${API_BASE}/instance/qr.png?ts=` + Date.now());
        if (resp.ok) {

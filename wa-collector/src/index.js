  ...
  sock.ev.on('messages.upsert', async ({ messages, type }) => {
    ...
    for (const msg of messages) {
      try {
        ...
        // Número da própria instância em dígitos (o que leu o QR)
        ...
        //    MAS ignoramos se for reply (hasQuoted)
        ...
        //    Também ignoramos se for reply
        let mentionedByText = false;
        if (!mentionedByContext && !hasQuoted && myNumberDigits && text) {

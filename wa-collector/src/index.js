...
async function createSock() {
  ...
  // AJUSTE: logger cru de mensagens para debug (se quiser, pode comentar depois)
  ...
  sock.ev.on('messages.upsert', async ({ messages, type }) => {
    ...
    for (const msg of messages) {
      try {
        ...
        // Número da própria instância em dígitos
        ...
        if (!mentionedByContext && myNumberDigits && text) {

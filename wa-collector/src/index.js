...
let sock: any = null;
let connState: string = 'connecting';
let latestQR: string | null = null;
let myJid: string | null = null;    // ex: 551199999999@s.whatsapp.net
let myDigits: string | null = null; // ex: 551199999999

// =========================
// Helpers
// =========================

function digits(str: string = ''): string {
  return (str || '').replace(/\D/g, '');
}

// helper para “normalizar” qualquer JID para apenas os dígitos
function normalizeJidToDigits(jid: string = ''): string {
...
function getContextInfo(msg: any) {
  if (!msg) return null;
  return (
...
async function sendWebhook(bodyObj: any) {
  try {
...
async function createSock() {
  ...
  // Logger cru de mensagens (agora em INFO pra aparecer no Render)

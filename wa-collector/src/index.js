...
function parseBoolEnv(value, defaultValue = false) {                                                                          
  ...
  // FORWARD_ALL=false -> só manda quando tiver @mention nativa (@ + selecionar contato)                                        
  ...
  <head>
    ...
    <style>
      ...
      .status-dot {
        width: 7px;
        height: 7px;ajuste 
        border-radius: 999px;ajuste 
      }ajuste 
      .status-dot-ok {ajuste 
        background: #22c55e;ajuste 
      }ajuste 
      .status-dot-warn {ajuste 
        background: #f97316;ajuste 
      }ajuste 
      .status-dot-err {ajuste 
        background: #ef4444;ajuste 
      }ajuste 
      .card {ajuste 
        border-radius: 14px;ajuste 
        border: 1px solid #1f2937;ajuste 
